#
#  Be sure to run `pod spec lint MTLayerManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ericericx"
  # s.authors            = { "ericericx" => "" }
  # s.social_media_url   = "http://twitter.com/ericericx"
  ...
  s.source_files  = "Source/MittapLayerSceneView.h"
